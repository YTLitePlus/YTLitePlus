...
before-package::
	...
	@mkdir -p Resources/Frameworks/Alderis.framework && find .theos/obj/install/@executable_path/Frameworks/Alderis.framework -maxdepth 1 -type f -exec cp {} Resources/Frameworks/Alderis.framework/ \;
