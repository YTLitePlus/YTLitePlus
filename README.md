> [!WARNING]
> YTLitePlus (this repository) is deprecated and should not be used. I may never update it as YTPlus is now paid. 
...
- **Fully open source** (GPLv3) - YouMod's entire codebase makes much more sense for doing PRs and etc than YTLitePlus’s.
...
- **No lite version spoofing** - cannot spoof the YouTube app version to bypass update prompts and as a need to "fix" some features that break.
- **No exclusive features** - lacks LowContrastMode, NotificationsTab, YTAppVersionSpoofer, and other YTLitePlus extras, other features differ from another.
- **Some reported bugs** - open issues include problems with fullscreen action hiding, Shorts feed visibility, and time slider positioning on certain YouTube versions, but much better than YTLitePlus’s list of problems.
